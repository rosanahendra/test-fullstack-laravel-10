                ...
                <table class="table table-bordered table_custom2" id="dataTable" width="100%" cellspacing="0">
    				<thead>
    				  <tr>
                        ...
                        <td class="table_header_30"><input type="text" class="form-control" onkeyup="search(this.value, '<?php echo $page; ?>', 1)" placeholder="Pencarian Kolom 1"></td>
                        <td class="table_header_30"><input type="text" class="form-control" onkeyup="search(this.value, '<?php echo $page; ?>', 2)" placeholder="Pencarian Kolom 2"></td>
                        <td class="table_header_30">
                            <div class="row">
